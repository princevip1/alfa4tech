    ...
    <footer class="bg-dark">
            ...
            <div class="row">
                <div class="f-items default-padding">
                    ...
                    <div class="col-md-8 equal-height item">
                        <div class="f-item">
                            <h4>About AMk</h4>
                            <h5 style="color:white">Simple and fast for your business.</h5>
                            <p>
                            The winning workforce of tomorrow starts today, with AMK Trading. We’re bringing the simplest development, collaboration, performance and engagement together in new ways of IT consulting, Networking, Security, Consulting & Management to assist you grow and your business thrive. AMK Trading has helped its customers with its accreditation through the power, having the ability to follow-up, and what has got to be addressed.
                            </p>
                            <h5 style="color:white">The History Of AMK Trading</h5>
                            <p>From our humble beginnings in Bangladesh to present day when AMK Trading is recognized as an industry-leading provider of innovative talent solutions, the story of AMK Trading is a tremendous one. Determine how, within the span of years, AMK Trading has earned the trust of the planet market. The demand for anytime and anywhere surged, and AMK Trading rose up to satisfy this need.</p>
                            <div class="social">
                                <ul>
                    ...
                    <!-- End Single Item -->
                    <!-- Single Item -->
                    <div class="col-md-4 equal-height item hidden">
                    ...
                    <div class="col-md-4 equal-height item">
                            <div class="f-item recent-post">
                                        <div class="heading">
                                            <h4 class="text-white">Request A Call Back</h4>
                                            <p> 
        ...
        <div class="footer-bottom bg-dark text-light">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <p>&copy; Copyright 2020. All Rights Reserved by <a href="#">AMK Trading</a></p>
                    </div>
